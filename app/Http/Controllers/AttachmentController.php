...
class AttachmentController extends Controller
{
    ...
    public function store(Request $request, Note $note)
    {
        ...
        try {
            ...
            DB::rollBack();
            foreach ($storedPaths as $path) Storage::disk($disk)->delete($path);
            return response()->json(['message' => 'Prílohy sa nepodarilo uložiť.'], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
